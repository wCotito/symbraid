...
- A committed MIT polyglot benchmark fixture, reproducible adapter manifests,
  and a dry-run harness.
- Build-only GitHub Actions, issue forms, pull-request guidance, and dependency
  update configuration.

### Verification status

- Benchmark measurements have not been executed. No performance numbers are
  claimed until an adapter run produces preserved raw artifacts and metadata.
