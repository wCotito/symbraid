...
The release candidate name is **Symbraid**. The exact name was checked through
public read-only registry APIs immediately before the release-readiness review:
...
registry search is not a trademark clearance, legal opinion, or guarantee that
the name is safe in every jurisdiction or product class; obtain an appropriate
legal review before a public commercial launch.